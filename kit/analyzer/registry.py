...
DASHBOARDS: tuple[Dashboard, ...] = (
    ...
    Dashboard("koc", "KOC Scorecard", "marketing",
              "Chấm điểm creator, phát hiện KOC đang lên",
              "CS3+CS9",
    ...
    Dashboard("sound", "Sound & Edit Kit", "editor",
              "Nhạc dùng lại + kết cấu nội dung (dạng bài, số ảnh, hashtag)",
              "CS10+CS13",
